...
class _HotelFormState extends State<HotelForm> {
  ...
  Future<String?> uploadImageToFirebaseStorage(File imageFile) async {
    try {
      ...
      final storageRef = storage.ref().child('hotel_images');
  ...
  Future<void> uploadDataToFirebase() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      logger.i("hotel posted successfully!");
    }
  }
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: "Enter hotel's phone number",
                        ),
                        keyboardType: TextInputType
          ...
          if (showAlert)
            Center(
              child: AlertDialog(
                ...
                content: const Text('hotel posted successfully!'),
                actions: [
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
