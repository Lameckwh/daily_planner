...
class CulturalCentresForm extends StatefulWidget {
  ...
  @override
  State<CulturalCentresForm> createState() => _CulturalCentresFormState();
}

class _CulturalCentresFormState extends State<CulturalCentresForm> {
  ...
  Future<String?> uploadImageToFirebaseStorage(File imageFile) async {
    try {
      ...
      final storageRef = storage.ref().child('cultural_centre_images');
  ...
  Future<void> uploadDataToFirebase() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      await FirebaseFirestore.instance.collection('cultural_centres').add({
        'name': name,
        'email': email,
      ...
      logger.i("cultural_centre posted successfully!");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Create cultural_centre'),
      ),
      body: Stack(
        children: [
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          ...
                          hintText: 'Enter cultural centre name',
                        ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Enter cultural centre email',
                        ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: "Enter cultural centre's phone number",
                        ),
                        keyboardType: TextInputType
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Enter cultural centre location',
                        ),
                        textCapitalization: TextCapitalization.sentences,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Enter cultural centre price',
                        ),
          ...
          if (showAlert)
            Center(
              child: AlertDialog(
                ...
                content: const Text('cultural_centre posted successfully!'),
                actions: [
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
