...
class _TransportFormState extends State<TransportForm> {
  ...
  Future<String?> uploadImageToFirebaseStorage(File imageFile) async {
    try {
      ...
      final storageRef = storage.ref().child('transport_images');
  ...
  Future<void> uploadDataToFirebase() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      await FirebaseFirestore.instance.collection('transports').add({
        'name': name,
        'email': email,
      ...
      logger.i("transport posted successfully!");
    }
  }
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Enter transport email',
                        ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: "Enter transport's phone number",
                        ),
                        keyboardType: TextInputType
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Enter transport destination',
                        ),
                        textCapitalization: TextCapitalization.sentences,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Enter transport price',
                        ),
          ...
          if (showAlert)
            Center(
              child: AlertDialog(
                ...
                content: const Text('transport posted successfully!'),
                actions: [
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
